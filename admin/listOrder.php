...
<div class="container" style="margin-top: 5%">
  ...
  <a href="listUser.php" style="text-decoration: none;"><li class="list-group-item " >Manage Users</li></a>
  <a href="listProduct.php" style="text-decoration: none;"><li class="list-group-item " >Manage Products</li></a>
  <a href="listOrder.php" style="text-decoration: none;"><li class="list-group-item active" >Manage Orders</li></a>
                                ...
                                <tbody>
                                    ...
                                    if (!mysqli_num_rows($query) > 0) {
                                        ...
                                        while ($rows = mysqli_fetch_array($query)) {
                                            ...
                                            $query_user = mysqli_query($db, $sql_usert);
                                            $user = mysqli_fetch_array($query_usert);
                                            echo ' <tr><td>' . $rows['id'] . '</td>
														<td>' . $rows['code'] . '</td>
														<td>' . $user['lastname'] ." ". $user['firstname'] . '</td>
														<td>' . $product['name'] . '</td>
														<td>' . $rows['quantity'] . '</td>
														<td style="text-transform:capitalize">' . $rows['status'] . '</td>	 
                                                        <td>' . $rows['payment'] . '</td>	
